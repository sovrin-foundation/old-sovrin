...
from plenum.common.txn import REPLY, STEWARD, NAME, VERSION, REQACK, REQNACK, TXN_ID, TARGET_NYM, NONCE
...
from sovrin.common.txn import TXN_TYPE, ATTRIB, DATA, GET_NYM, ROLE, \
    SPONSOR, NYM, GET_TXNS, LAST_TXN, TXNS, CRED_DEF, ISSUER_KEY, SKEY, DISCLO, GET_ATTR
