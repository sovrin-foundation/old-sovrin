...
class ClientStorage(HasFileStorage):
    ...
    def __init__(self, clientName):
        ...
        self.reqStore = FileStore(self.clientDataLocation, "RQ")
        self.ackStore = FileStore(self.clientDataLocation, "A")
        self.nackStore = FileStore(self.clientDataLocation, "N")
        self.replyStore = FileStore(self.clientDataLocation, "R")
